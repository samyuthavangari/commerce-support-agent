"""Offline calibration v2 of escalation rules vs HUMAN labels (no LLM calls)."""
...
def main():
    g = pd.read_csv("golden_set/golden_250.csv").set_index("message_id")
    r = pd.read_csv("results/agent_replies.csv").set_index("message_id")
