"""Full offline refresh after the top-up label fix (no API except the LLM
tiebreaker, and only for ambiguous-shaped rows).

Recomputes: intent metrics + CIs, escalation metrics + CM, baselines,
confusion-matrix PNG, boundary table, 5-set escalation table, eval_report.
"""
