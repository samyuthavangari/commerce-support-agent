"""Fix GS_0201-GS_0218 labels: the top-up sampler regenerated its pool on the
second run (new exclusion), so rows T001-T018 hold DIFFERENT threads than the
texts reviewed in the first labelling pass. This applies the corrected
row-by-row review against the ACTUAL file texts. T019-T050 labels were made
against this file and are untouched. LLM first-pass columns stay (they were
computed on these exact texts).
"""
