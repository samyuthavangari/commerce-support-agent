...
───────────────────────────
Evaluates model confidence calibration across the golden evaluation set.

Computes:
  - Expected Calibration Error (ECE)
  - Maximum Calibration Error (MCE)
  - Brier Score (mean squared error of predicted probabilities)
  - Reliability Diagram data table
  - Evidence-Calibrated Certainty metric

Saves report to results/calibration_report.json.
"""
