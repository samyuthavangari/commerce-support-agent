"""
scripts/eval_stress_end_to_end.py
─────────────────────────────────
Evaluates the 50-case adversarial stress suite through the full LOCKED multi-layer pipeline:
  Layer 1: Deterministic Rules (Safety, Legal, PII, Fraud, Repeat, Public PII)
  Layer 2: Precedent Consensus Agreement (Agreement >= 0.30 veto, Contested >= 0.60 check)
  Layer 3: Grounding Verification (Groundedness >= 3.0)
  Layer 4: Calibrated Certainty (Calibrated Confidence >= 0.70 threshold)

Reports strict verification:
  Policy locked: YES
