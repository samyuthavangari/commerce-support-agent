"""
scripts/run_locked_protocol.py
──────────────────────────────
Comprehensive verification of the locked safety protocol across all splits.

Protocol:
  1. Calibration Set (cal_100 + cal2_100, N=200):
     - Fit empirical confidence calibration mapping
     - Grid search Pareto-optimal safe auto-handle boundaries
  2. LOCK POLICY:
     - Policy locked: YES
     - Thresholds modified after test: NO
  3. Untouched Test Evaluation (N=400):
     - golden_250.csv (N=250)
     - heldout_50.csv (N=50, Holdout A)
     - heldoutB_50.csv (N=50, Holdout B)
     - stress_test_50.csv (N=50, Adversarial Stress Suite)
  4. Failure Analysis of Remaining Over-Escalations (False Positives)
"""
