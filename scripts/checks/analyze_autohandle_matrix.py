"""
scripts/checks/analyze_autohandle_matrix.py
───────────────────────────────────────────
Computes coverage and safety metrics across retrieval similarity and confidence matrices.
When run: Executed to analyze trade-offs in safe auto-handling.
Reproducibility: Repeatable analysis script.
"""
