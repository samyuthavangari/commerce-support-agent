"""
scripts/checks/optimize_autohandle_boundary.py
──────────────────────────────────────────────
48-configuration grid search to find Pareto-optimal auto-handling thresholds.
When run: Executed during safe operating boundary derivation on calibration splits.
Reproducibility: Repeatable optimization script.
"""
