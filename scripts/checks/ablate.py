"""
scripts/checks/ablate.py
────────────────────────
Evaluates reply quality with retrieval (RAG) vs without retrieval (ablation study).
When run: Executed to measure empirical lift of vector retrieval context.
