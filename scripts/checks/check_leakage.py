"""
scripts/checks/check_leakage.py
───────────────────────────────
Contract §6 automated data contamination and leak checks (eval thread exclusion, verbatim text, top-K).
When run: Auto-executed by run_eval.py and run standalone prior to benchmark publication.
Reproducibility: Repeatable verification gate.
"""
