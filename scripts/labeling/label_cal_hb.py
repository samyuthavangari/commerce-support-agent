"""
scripts/labeling/label_cal_hb.py
────────────────────────────────
Generates human escalation ground truth for CAL-100 and frozen HELDOUT-B-50.
When run: Executed during dataset split creation to establish isolated evaluation boundaries.
